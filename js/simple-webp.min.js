...
default:var str=el.style.backgroundImage;var p1=str.indexOf('url("')+5;var p2=str.indexOf('")',p1+1);var src=str.slice(p1,p2);src=src.replace(/\.[a-zA-Z]{3,5}/g,'.webp');el.style.backgroundImage='url("'+src+'")'
break}});}
